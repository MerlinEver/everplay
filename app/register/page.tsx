          ...
          <form onSubmit={handleRegister} className="flex flex-col gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-2xl bg-white/70 border border-[#dcd0f0] text-[#5B4A7A] placeholder-[#b8a8d0] outline-none transition-all duration-300 focus:border-[#9C7BFF] focus:bg-white focus:shadow-[0_0_0_4px_rgba(156,123,255,0.08)] hover:border-[#c4b0f0] hover:shadow-[0_0_0_4px_rgba(156,123,255,0.04)] text-sm"
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-3 rounded-2xl bg-white/70 border border-[#dcd0f0] text-[#5B4A7A] placeholder-[#b8a8d0] outline-none transition-all duration-300 focus:border-[#9C7BFF] focus:bg-white focus:shadow-[0_0_0_4px_rgba(156,123,255,0.08)] hover:border-[#c4b0f0] hover:shadow-[0_0_0_4px_rgba(156,123,255,0.04)] text-sm"
              />
              <button
                type="button"
