...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#ece6f3] text-[#5B4A7A] font-sans flex items-center justify-center p-4 md:p-8">
      ...
      {/* 主容器 */}
      <div className="w-full max-w-md rounded-[40px] overflow-hidden shadow-2xl shadow-[#b8a0e8]/20">
        {/* 登录卡片 */}
        <div className="bg-white/60 backdrop-blur-xl px-8 py-12 md:px-14 md:py-16 flex flex-col">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3.5 rounded-2xl bg-white/70 border border-[#dcd0f0] text-[#5B4A7A] placeholder-[#b8a8d0] outline-none transition-all duration-300 focus:border-[#9C7BFF] focus:bg-white focus:shadow-[0_0_0_4px_rgba(156,123,255,0.08)] hover:border-[#c4b0f0] hover:shadow-[0_0_0_4px_rgba(156,123,255,0.04)] text-sm"
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-3.5 rounded-2xl bg-white/70 border border-[#dcd0f0] text-[#5B4A7A] placeholder-[#b8a8d0] outline-none transition-all duration-300 focus:border-[#9C7BFF] focus:bg-white focus:shadow-[0_0_0_4px_rgba(156,123,255,0.08)] hover:border-[#c4b0f0] hover:shadow-[0_0_0_4px_rgba(156,123,255,0.04)] text-sm"
              />
              <button
                type="button"
            ...
            <button
              type="submit"
              className="mt-2 w-full py-3.5 rounded-2xl bg-gradient-to-r from-[#9C7BFF] to-[#b392f0] text-white text-base font-medium tracking-wide shadow-lg shadow-[#9C7BFF]/25 hover:shadow-xl hover:shadow-[#9C7BFF]/35 hover:from-[#8d6aef] hover:to-[#a580e8] transition-all duration-300 backdrop-blur-sm"
            >
              登录 →
            </button>
          </form>
          ...
          <div className="flex gap-3">
            <button className="flex-1 py-3 rounded-2xl bg-white/50 border border-[#e8dcf6] flex items-center justify-center gap-2 text-sm text-[#6d5a87] hover:bg-white hover:border-[#c4b0f0] hover:shadow-[0_0_0_4px_rgba(156,123,255,0.04)] transition-all">
